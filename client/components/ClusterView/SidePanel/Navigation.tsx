...
const Navigation: FC<Navigation> = ({ setViewOverview, setViewNode, setViewPods, setViewClusterMap }) => {
  return (
    <nav className='flex items-center justify-center py-7 gap-5 sm:flex-col '>
      ...
      }} className='hover:bg-[var(--secondary)] hover:px-2 hover:py-1 my-0 hover:text-[var(--primary)] rounded flex items-center gap-1 dark:hover:text-[var(--secondary)] dark:hover:bg-[var(--primary)]'><span className='material-symbols-outlined'>overview</span>Overview</button>
      {/* END OF ONE NavLink */}
      ...
      }} className='hover:bg-[var(--secondary)] hover:px-2 hover:py-1 my-0 hover:text-[var(--primary)] rounded flex items-center gap-1 dark:hover:text-[var(--secondary)] dark:hover:bg-[var(--primary)]'>  <FaCircleNodes size={22} /> Cluster Map</button>
